  ...
  return (
    <footer className="border-t border-white/5 bg-slate-950/90 pt-16 pb-12 mt-auto">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10">
        <div className="space-y-4">
          ...
          <p className="text-slate-400 text-sm leading-relaxed">
            The next-generation Ticket discovery and seamless ticket booking platform connecting passionate organizers with eager attendees.
          </p>
        ...
        <div>
          <h3 className="text-white font-semibold text-sm uppercase tracking-wider mb-4">Discover Ticket</h3>
          <ul className="space-y-2 text-slate-400 text-sm">
            <li><Link href="/events?category=Music" className="hover:text-white transition-colors">Bus Ticket</Link></li>
            <li><Link href="/events?category=Tech" className="hover:text-white transition-colors">Train Ticket</Link></li>
            <li><Link href="/events?category=Sports" className="hover:text-white transition-colors">Sheep Ticket</Link></li>
            <li><Link href="/events?category=Arts" className="hover:text-white transition-colors">Airoplaine Ticket</Link></li>
          </ul>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 border-t border-white/5 mt-12 pt-8 text-center text-slate-500 text-xs">
        <p>&copy; {new Date().getFullYear()} TicketHub Inc. All rights reserved. Developed by Antigravity AI.</p>
      </div>
    </footer>
  );
}
