  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-5 bg-gradient-to-br from-slate-950 via-slate-900 to-black relative overflow-hidden">
      ...
      <Card className="relative w-full max-w-md border border-white/10 bg-white/5 backdrop-blur-2xl shadow-2xl rounded-3xl p-6 text-white">
          ...
          <h1 className="text-3xl font-black bg-gradient-to-r from-white via-slate-200 to-pink-500 bg-clip-text text-transparent">
            Welcome Back 🚀
          </h1>
...
/>
            ...
            <Button
              ...
              type="submit"
              className="w-full h-11 rounded-xl bg-gradient-to-r from-pink-500 to-indigo-600 text-white font-bold text-sm shadow-lg shadow-pink-500/20 hover:opacity-95 transition"
            >
              Sign In
            </Button>
          </form>
          ...
          <Button
            ...
            variant="bordered"
            className="w-full border-white/10 text-slate-300 hover:bg-white/5 h-11 rounded-xl text-xs font-semibold"
            startContent={<FaGoogle className="text-xs" />}
          >
